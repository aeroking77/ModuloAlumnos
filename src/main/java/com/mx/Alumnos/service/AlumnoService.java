...
public class AlumnoService {
    ...
    AlumnoService(AlumnoDao alumnoDao) {
    ...
    public Respuesta guardar(Alumno alumno) {
        if(alumnoDao.existsById(alumno.getMatricula())) {
            return new Respuesta("El alumno no ha sido agregado por que su matricula ya existe", false, alumno.getMatricula());
        }
        alumnoDao.save(alumno);
        return new Respuesta("El alumno ha sido agregados", true, alumno);
    }
